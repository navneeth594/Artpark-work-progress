...
def get_depth_at_pixel(depth_frame, pixel_x, pixel_y):
	...
	"""
	return depth_frame.as_depth_frame().get_distance(round(pixel_y), round(pixel_x))
...
while True:        # Get frameset of color and depth
	...
	if key==ord('s'):
		...
		np.save('./countertop_with_markers/pcl_files/pcl'+str(count),threed)
		cv2.imwrite('./countertop_with_markers/RGB_new/rgb'+str(count)+'.jpg',color_image)
