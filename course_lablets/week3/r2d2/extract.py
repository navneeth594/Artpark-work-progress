...
def extract_keypoints(model_path,img_path,num_keypoints):
    ...
    idxs = scores.argsort()[num_keypoints or None:]
    keypoints=xys[idxs]
...
if __name__ == '__main__':
    ...
    extract_keypoints('./models/r2d2_WASF_N16.pt','./imgs/brooklyn.png',5000)
