...
def vizualize_matches(framepair):
    ...
    out_img = cv2.drawMatches(framepair.frame1.image, cv_kp1, framepair.frame2.image, cv_kp2, dmtches[::100], None, (0,255,255), -1, None, 2)
    out_img=cv2.cvtColor(out_img,cv2.COLOR_BGR2RGB)
    plt.figure(figsize=(30,20))
    plt.imshow(out_img)
    plt.show()

def evaluate_r2d2(ref_img,cur_img):
  imgidx = 1
  ...
  return number_matches/avg_keypts,execution_time
